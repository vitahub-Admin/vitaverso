...
export async function GET() {
    try {
      ...
      try {
        ...
        // archivo no existe o roto → crear con default
        json = { banners: [DEFAULT_BANNER] };
      ...
      // Si algo falla, SIEMPRE devolvemos default
...
export async function POST(req) {
  ...
  export async function PUT(req) {
    ...
    // Si viene vacío, restauramos el default
    const newList = body.banners.length > 0 ? body.banners : [DEFAULT_BANNER];
